...
<head>
	...
	<script href="/home_public/js/jquery.1.12.4.min.js" charset="UTF-8"></script>
	<script href="/home_public/js/bootstrap.min.js" charset="UTF-8"></script>
	<script href="/home_public/js/swiper.min.js" charset="UTF-8"></script>
	<script href="/home_public/js/global.js" charset="UTF-8"></script>
	<script href="/home_public/js/jquery.DJMask.2.1.1.js" charset="UTF-8"></script>
	<title>U袋网</title>
</head>
<body>
	<!-- 顶部tab -->
		...
		<section class="item-show__div clearfix">
			<div class="pull-left">
				<div class="item-list__area clearfix">
					...
					<div class="item-card">
						<a href="/home/tiem/{{ $v->id}}/edit" class="photo">
							<img src="/admin_public/{{ $v->pic }}" alt="锦瑟 原创传统日常汉服男绣花交领衣裳cp情侣装春夏款" class="cover">
			...
			<div class="pull-right">
				...
				<div class="desc-segments__content">
					...
					<div class="picked-box">
						<a href="" class="picked-item"><img src="/home_public/images/temp/S-001.jpg" alt="" class="cover"><span class="look_price">¥134.99</span></a>
						<a href="" class="picked-item"><img src="/home_public/images/temp/S-002.jpg" alt="" class="cover"><span class="look_price">¥134.99</span></a>
						<a href="" class="picked-item"><img src="/home_public/images/temp/S-003.jpg" alt="" class="cover"><span class="look_price">¥134.99</span></a>
						<a href="" class="picked-item"><img src="/home_public/images/temp/S-004.jpg" alt="" class="cover"><span class="look_price">¥134.99</span></a>
						<a href="" class="picked-item"><img src="/home_public/images/temp/S-005.jpg" alt="" class="cover"><span class="look_price">¥134.99</span></a>
						<a href="" class="picked-item"><img src="/home_public/images/temp/S-006.jpg" alt="" class="cover"><span class="look_price">¥134.99</span></a>
						<a href="" class="picked-item"><img src="/home_public/images/temp/S-007.jpg" alt="" class="cover"><span class="look_price">¥134.99</span></a>
						<a href="" class="picked-item"><img src="/home_public/images/temp/S-008.jpg" alt="" class="cover"><span class="look_price">¥134.99</span></a>
						<a href="" class="picked-item"><img src="/home_public/images/temp/S-009.jpg" alt="" class="cover"><span class="look_price">¥134.99</span></a>
						<a href="" class="picked-item"><img src="/home_public/images/temp/S-010.jpg" alt="" class="cover"><span class="look_price">¥134.99</span></a>
					</div>
				</div>
			</div>
		</section>
